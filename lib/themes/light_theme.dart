...
ThemeData get LIGHT_THEME {
  return ThemeData(
    ...
    // scaffoldBackgroundColor: white.withOpacity(0.95),
    ...
    dividerTheme: const DividerThemeData(thickness: 1, space: 1, color: offWhite1),
...
get _datePickerThemeData {
  return DatePickerThemeData(
    ...
    cancelButtonStyle: const ButtonStyle(foregroundColor: WidgetStatePropertyAll(grey1)),
    confirmButtonStyle: const ButtonStyle(foregroundColor: WidgetStatePropertyAll(grey1)),
    weekdayStyle: TextStyles.text15_500.copyWith(color: grey3),
    dayStyle: TextStyles.text15_500.copyWith(color: grey3),
...
get _sliderThemeData {
  return const SliderThemeData(
    ...
    valueIndicatorTextStyle: TextStyle(color: white, fontSize: 13, height: 1.38, fontWeight: w500, fontFamily: archivo),
...
get _tabBarTheme => TabBarTheme(
      ...
      unselectedLabelStyle: TextStyles.text13_400,
...
get _appBarTheme {
  return AppBarTheme(
    ...
    titleTextStyle: TextStyles.text18_600.copyWith(color: grey1),
    toolbarTextStyle: TextStyles.text18_600.copyWith(color: grey1),
...
get _bottomNavigationBarTheme {
  return const BottomNavigationBarThemeData(
    ...
    unselectedItemColor: offWhite2,
    selectedIconTheme: IconThemeData(size: 24, color: white),
    unselectedIconTheme: IconThemeData(size: 24, color: offWhite2),
    selectedLabelStyle: TextStyle(color: white, fontSize: 14, height: 1.57, fontWeight: w500, fontFamily: archivo),
    unselectedLabelStyle: TextStyle(color: offWhite2, fontSize: 14, height: 1.57, fontWeight: w500, fontFamily: archivo),
...
get _elevatedButtonTheme {
  return ElevatedButton.styleFrom(
    ...
    backgroundColor: primary,
    disabledForegroundColor: offWhite2,
...
get _outlineButtonTheme {
  return OutlinedButton.styleFrom(
    ...
    minimumSize: const Size(50, 48),
    maximumSize: const Size(double.infinity, 48),
    side: const BorderSide(color: offWhite1),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
    visualDensity: VisualDensity.standard,
  );
}
