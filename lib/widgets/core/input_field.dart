...
class InputField extends StatelessWidget {
  ...
  InputDecoration get _inputDecoration {
    return InputDecoration(
      ...
      prefixIconColor: _is_disabled ? grey2 : WidgetStateColor.resolveWith((states) => states.contains(WidgetState.focused) ? dark : grey2),
      suffixIconColor: _is_disabled ? grey2 : WidgetStateColor.resolveWith((states) => states.contains(WidgetState.focused) ? dark : grey2),
      ...
      // labelStyle: TextStyles.text15_500.copyWith(color: _is_disabled ? grey2 : dark),
      labelStyle: TextStyle(fontSize: 15, height: 1, fontWeight: w500, fontFamily: archivo, color: _is_disabled ? grey2 : dark),
      hintStyle: const TextStyle(fontSize: 15, height: 1, fontWeight: w500, fontFamily: archivo, color: grey2),
      // hintStyle: TextStyles.text15_500.copyWith(color: grey2),
      errorStyle: const TextStyle(fontSize: 15, height: 1, fontWeight: w500, fontFamily: archivo, color: error),
    );
  }
